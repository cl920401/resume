...
\cvitem{}{主要负责支持windows平台两个游戏盒子产品迭代的开发和bug修复工作，独立跟进业务需求以及设计并重构优化框架代码}
...
\subsection{\textbf{AI工程平台 - 机器人后端及数据中台服务}}
...
\subsection{\textbf{海外工具平台 - 海外APP后端}}
...
% \newpage
\section{自我评价}
\cvitem{}{为了方便贵公司快速了解我，个人总结了自己的一些特点在下面列出，如果贵公司正好需要我的这些特质，期待合作～}
\cvitem{}{1、C++的基础让我对底层原理部分有更好的理解能力，能快速学习，对技术深度有一定要求}
\cvitem{}{2、个人的主要发展基本是兴趣驱动，对于新的技术知识有强烈的学习热情}
