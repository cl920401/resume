...
\subsection{\textbf{AI机器人服务端}}
\cventry{}{mini机器人服务端开发}{}{}{}{}
\cvitem{关键词}{超长链路、多方对接、项目负责人}
\cvitem{项目介绍}{mini机器人是ToC的机器人，是公司对机器人ToC的尝试，需要对接机器人端系统层到应用层，官方app，nlp平台等，是一个链路超长、比较庞大的系统}
\cvitem{工作内容}{服务端组的接口人和负责人，整体方案的设计，核心功能的研发，团队的整体进度把控、开发规范制定等}
\cvitem{技术栈}{golang、linux、k8s、docker、kong、elk、mysql、redis、kafka、mqtt、git}

\newpage
\subsection{\textbf{OrionBase}}
\cventry{}{Golang Web后台开发}{}{}{}{}
\cvitem{关键词}{机器人Paas平台、账号权限系统}
\cvitem{项目介绍}{OrionBase是一个机器人开发者平台，主要支持对机器人的远程发布和操作，并且提供查看崩溃，数据总览，监控预警等基础服务。支持公司AI场景落地的产品}
\cvitem{工作内容}{主要负责权限和账号体系的设计和研发，以及各种业务数据聚合接口的开发和其他功能的维护工作。值得一提的是，这个项目用了微服务架构的思路，网关统一在kong配置，后面代理了多个微服务}
\cvitem{技术栈}{golang、linux、k8s、docker、kong、elk、mysql、redis、git}

\subsection{\textbf{DMP平台}}
\cventry{}{Golang Web后台及组件开发}{}{}{}{}
\cvitem{关键词}{内容分发Paas平台、账号权限系统}
...
\cvitem{关键词}{windows平台浏览器开发、独立完成系统设计的能力}
...
\cventry{}{C++ Windows客户端开发}{}{}{}{}
\cvitem{关键词}{windows平台浏览器开发、chrome源码阅读能力}
...
\section{自我评价}
\cvitem{}{五年的工作时间我觉得不算短了，我自己时常总结和反思，和其他人相比我的优劣势是什么？以下是我个人总结的几大特点：}
\cvitem{}{1、开始的两年主要使用c++，培养了良好的编码习惯和阅读源码的基础，解决问题习惯于从底层原理分析}
\cvitem{}{2、后面的三年转岗服务端，得益于良好的基础，拥抱变化，快速学习java、python、golang等语言，微服务生态，并且有一个持续的积累过程}
