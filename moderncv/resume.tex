...
\cventry{}{Java后端研发工程师}{}{}{}{}
\cvitem{关键词}{全流程参与、主导研发节奏、分布式长连接维护}
...
\newpage
\subsection{\textbf{清理云服务维护}}
\cventry{}{多个后端模块维护}{}{}{}{}
\cvitem{关键词}{高DAU、linux维护和排查调试以及优化、迅速接手老项目，新语言快速学习}
...
\cvitem{关键词}{快速学习、内容分发}
\cvitem{项目介绍}{支持公司多款工具APP的后端接口、如cmlauncher、keyboard等出海app，主要涉及数据下发、技术预研、业务需求跟进等}
\cvitem{工作内容}{RestfulAPI的研发，涉及到下发资源，个性化推荐的相关接口}
